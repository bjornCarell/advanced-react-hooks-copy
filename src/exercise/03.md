...
useContext is often better suited for libraries than our applications. At times
though it can be useful in our applications as well. The useContext hook can
help us ease the pain of prop drilling when lifting state. Remember, prop
drilling is not a problem, but it can be a pain.
