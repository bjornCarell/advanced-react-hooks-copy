...
Use when calling a function inside of useEffect. Use when dependencies are
passed from props and are non primitives. Use to wrap a function, when that
function is defined inside a component and is passed to a useEffect dependencies
list.
