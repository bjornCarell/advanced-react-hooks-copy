...
Elaborate on your learnings here in `src/exercise/02.md` Elaborate on your
learnings here in `src/exercise/02.md` 
...
Use when calling a function inside of useEffect. 
Use when dependencies are passed from props and are non primitives.
Use to wrap a function, when that function is defined inside a component and is 
passed to a useEffect dependencies list. 


Remember: useMemo and useCallback makes your code more complex and harder to
read and understand. Use these hooks with great care, when the optimization
needs are screaming in your face.
